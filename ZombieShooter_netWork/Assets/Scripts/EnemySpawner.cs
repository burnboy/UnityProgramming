...
public class EnemySpawner : MonoBehaviourPun,IPunObservable {
    ...
    private int enemyCount = 0;//남은 적 수
    ...
    private void CreateEnemy(float intensity) {
        ...
        //intensity를 기반으로 하얀색과 enemyStrength사이에서 적의 피부색 결정
    ...
    //포톤의 PhotonNetwork.Destroy()는 지연파괴를 지원하지 않으므로 지연파괴를 직접 구현함
